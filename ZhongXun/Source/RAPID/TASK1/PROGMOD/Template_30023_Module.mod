MODULE Template_30023_Module
    !*****************************************************
    !Module Name:   Template_30023_Module
    !Version:       1.0
    ...
    PROC Template_30023()
        Logging "Start to run Template_30023...";
        ...
        EOffsOff;
        Incr numPartCount;
        Logging "Template_30023 is done";
    ...
    LOCAL PROC SearchOframe()
        ...
        WriteSysDataLog "Template_30023";
