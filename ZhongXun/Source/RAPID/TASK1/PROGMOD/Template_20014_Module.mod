MODULE Template_20014_Module
    ...
    LOCAL PERS robtarget pQ4_Y1_Found:=[[-24.74,-268.27,8.28],[0.183013,-0.612372,0.683013,-0.353553],[-1,0,-1,1],[-800,500,456,9E+09,9E+09,9E+09]];
    LOCAL PERS robtarget pQ4_Y2_Found:=[[-25.73,-117.98,7.25],[0.183013,-0.612372,0.683013,-0.353553],[-1,0,-1,1],[-800,500,456,9E+09,9E+09,9E+09]];
    LOCAL PERS robtarget pQ4_Z1_Found:=[[0,0,50],[0.562422,0.303603,0.732963,-0.232963],[-1,-2,-1,1],[-800,500,456,9E+9,9E+9,9E+9]];
    LOCAL PERS robtarget pQ4_Z2_Found:=[[-27.6,-17.32,328.46],[0.232963,0.732963,-0.303603,0.562422],[-2,-1,1,1],[-800,500,456,9E+09,9E+09,9E+09]];

    LOCAL PERS wobjdata wobjLast:=[FALSE,TRUE,"",[[-2160,-50,60],[1,0,0,0]],[[-26.3786,-19.518,6.5752],[1,0,0,0]]];
    LOCAL PERS pose poseFrame:=[[-26.3786,-19.518,6.5752],[0.500997,0.49569,0.502411,0.500876]];
    ...
    LOCAL PERS robtarget pSeamFound1_1:=[[119.06,12.45,0.94],[0.120591,-0.0499502,-0.915976,0.37941],[0,0,0,1],[800,500,480,9E+09,9E+09,9E+09]];
    LOCAL PERS robtarget pSeamFound1_2:=[[43.76,10.5,0.85],[0.120591,-0.0499502,-0.915976,0.37941],[0,0,0,1],[800,500,480,9E+09,9E+09,9E+09]];
    LOCAL PERS robtarget pSeamFound2_1:=[[4.1,8.06,69.16],[0.232963,0.732963,0.303603,-0.562422],[1,0,-1,1],[800,500,456,9E+09,9E+09,9E+09]];
    LOCAL PERS robtarget pSeamFound2_2:=[[1.67,13.83,236.2],[0.562422,0.303603,-0.732963,0.232963],[1,0,-1,1],[800,500,456,9E+09,9E+09,9E+09]];
    LOCAL PERS robtarget pSeamFound3_1:=[[100.06,0.39,3.63],[0.120591,0.0499502,-0.915976,-0.37941],[0,-1,-1,1],[800,-500,480,9E+09,9E+09,9E+09]];
    LOCAL PERS robtarget pSeamFound3_2:=[[39.89,-0.45,3.1],[0.120591,0.0499502,-0.915976,-0.37941],[0,-1,-1,1],[800,-500,480,9E+09,9E+09,9E+09]];
    LOCAL PERS robtarget pSeamFound4_1:=[[-3.53,-5.69,43.09],[0.232963,-0.732963,0.303603,0.562422],[0,-1,0,1],[800,-500,480,9E+09,9E+09,9E+09]];
    LOCAL PERS robtarget pSeamFound4_2:=[[0.29,3.32,483.16],[0.562422,-0.303603,-0.732963,-0.232963],[0,-1,0,1],[800,-500,480,9E+09,9E+09,9E+09]];
    ...
    LOCAL PERS pose peSeam21_1:=[[-5.34813,8.3976,5.98374],[1,0,0,0]];
    LOCAL PERS pose peSeam21_2:=[[-8.34813,13.3976,6.98374],[1,0,0,0]];
    LOCAL PERS pose peSeam21_3:=[[-10.3481,13.3976,5.98374],[1,0,0,0]];
    LOCAL PERS pose peSeam21_4:=[[30.1079,8.36047,7.79741],[1,0,0,0]];
    LOCAL PERS pose peSeam21_5:=[[18.0882,8.36099,10.8174],[1,0,0,0]];
    LOCAL PERS pose peSeam21_6:=[[15.1079,8.36047,17.7974],[1,0,0,0]];
    LOCAL PERS pose peSeam21_7:=[[14.6552,10.1163,-0.261726],[1,0,0,0]];
    LOCAL PERS pose peSeam21_8:=[[1.67706,26.1577,-1.51544],[1,0,0,0]];
    LOCAL PERS pose peSeam24_1:=[[-5.04666,0.863166,-6.07145],[1,0,0,0]];
    LOCAL PERS pose peSeam24_2:=[[-10.0467,0.863166,-5.07145],[1,0,0,0]];
    LOCAL PERS pose peSeam24_3:=[[-5.3111,11.7457,8.70337],[1,0,0,0]];
    LOCAL PERS pose peSeam24_4:=[[5.38939,10.519,9.15759],[1,0,0,0]];
    LOCAL PERS pose peSeam24_5:=[[-2.58249,7.96028,8.53423],[1,0,0,0]];
    LOCAL PERS pose peSeam24_6:=[[-1.77281,11.1319,8.11475],[1,0,0,0]];
    LOCAL PERS pose peSeam24_7:=[[-0.927496,10.7116,-0.17276],[1,0,0,0]];
    LOCAL PERS pose peSeam24_8:=[[-3.14255,20.281,-0.495239],[1,0,0,0]];
    ...
    LOCAL PROC Seam_24()
        ...
        MoveAbsJ [[48.0944,-26.8531,-4.85096,116.84,76.8333,-52.285],[871.349,-465.411,-465.321,9E+09,9E+09,9E+09]],speedAir,zoneAir,toolWeldGun\WObj:=wobjCurrent;
