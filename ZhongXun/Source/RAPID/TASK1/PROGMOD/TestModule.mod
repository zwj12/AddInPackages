MODULE TestModule
    ...
    PROC WeldTestByLaser_3()
        ...
        ArcLEnd pSeam3_2,speedWeld,seamShared,weldShared_2\Weave:=weaveShared_2,fine,toolWeldGun\WObj:=wobj0\Track:=trackShared_2;
        MoveL GetAproachTarget(pSeam3_2),speedAir,zoneAir,toolWeldGun\WObj:=wobj0;

        !Layer - 2
        RefreshDisp\X\Y\Z,peSeam3_3,posAOSeam3_3,pSeam3_3,pSeamFound3_1,pSeamFound3_2;
        MoveJ GetAproachTarget(pSeam3_3),speedAir,zoneAir,toolWeldGun\WObj:=wobj0;
        ArcLStart pSeam3_3,speedAproach,seamShared,weldShared_2\Weave:=weaveShared_2,fine,toolWeldGun\WObj:=wobj0\Track:=trackShared_2\SeamName:="WeldSeam";
        RefreshDisp\X\Y\Z,peSeam3_4,posAOSeam3_4,pSeam3_4,pSeamFound3_1,pSeamFound3_2;
        ArcLEnd pSeam3_4,speedWeld,seamShared,weldShared_2\Weave:=weaveShared_2,fine,toolWeldGun\WObj:=wobj0\Track:=trackShared_2;
        MoveL GetAproachTarget(pSeam3_4),speedAir,zoneAir,toolWeldGun\WObj:=wobj0;

        !Layer - 3
        RefreshDisp\X\Y\Z,peSeam3_5,posAOSeam3_5,pSeam3_5,pSeamFound3_1,pSeamFound3_2;
        MoveJ GetAproachTarget(pSeam3_5),speedAir,zoneAir,toolWeldGun\WObj:=wobj0;
        ArcLStart pSeam3_5,speedAproach,seamShared,weldShared_2\Weave:=weaveShared_2,fine,toolWeldGun\WObj:=wobj0\Track:=trackShared_2\SeamName:="WeldSeam";
